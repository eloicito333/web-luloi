...
function ChatPage() {
  const {messageManager, messages, areMessagesLoaded, whoami} = useChatContext();
  ...
  return (
    <main className="absolute top-0 left-0 bg-pink-200 z-40 w-full h-dvh flex flex-col justify-start items-center">
